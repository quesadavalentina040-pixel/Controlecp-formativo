...
@section('content')
        ...
        <div class="container">
            ...
            <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('controlecp.index') }}">
                <img src="{{ asset('general/assets/img/logo-ecp.png') }}" 
                     ...
                     style="height: 46px; width: 46px; object-fit: contain; background: #ffffff; border-radius: 50%; padding: 2px; box-shadow: 0 2px 8px rgba(116, 198, 157, 0.35); border: 2px solid var(--sena-pastel-primary);">
                <div>
                    <span class="d-block fw-bold fs-5" style="color: var(--sena-pastel-text-title); line-height: 1.1;">Escuela Cultura de Paz</span>
                    <span class="badge rounded-pill fw-bold" style="background-color: var(--sena-pastel-light); color: var(--sena-pastel-text-title); font-size: 0.68rem; letter-spacing: 0.5px; border: 1px solid rgba(116, 198, 157, 0.5);">Control ECP • SENA</span>
                </div>
            </a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 p-2 mt-2" style="background-color: #ffffff; border: 1px solid rgba(116, 198, 157, 0.3) !important;">
                            ...
                            <li>
                                <a class="dropdown-item rounded-3 py-2 my-1" href="{{ url('/') }}">
                                    <i class="fas fa-cubes me-2" style="color: #2d6a4f;"></i> Módulos ERP SENA
                                </a>
                            </li>
    ...
    <section id="hero-carousel" class="ecp-hero-carousel position-relative">
        <div id="carouselControlECP" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="6000">
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselControlECP" data-bs-slide="prev">
                <span class="carousel-control-prev-icon rounded-circle p-3" style="background-color: rgba(116, 198, 157, 0.7);" aria-hidden="true"></span>
                <span class="visually-hidden">Anterior</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselControlECP" data-bs-slide="next">
                <span class="carousel-control-next-icon rounded-circle p-3" style="background-color: rgba(116, 198, 157, 0.7);" aria-hidden="true"></span>
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6">
                    <div class="ecp-feature-img-box position-relative">
                        <!-- Banner con degradado verde pastel suave -->
                        <div class="p-5 text-center d-flex flex-column justify-content-center align-items-center" 
                             style="min-height: 420px; background: linear-gradient(135deg, #d8f3dc 0%, #b7e4c7 50%, #74c69d 100%);">
                            <div class="rounded-circle p-4 mb-4 shadow-sm" style="background: rgba(255, 255, 255, 0.85); border: 2px solid #ffffff;">
                                <i class="fas fa-users-rays fa-4x" style="color: #1b4332;"></i>
                            </div>
                            <h3 class="fw-bold mb-2" style="color: #1b4332;">Comunidad Educativa Unida</h3>
                            <p class="small mb-0 px-3 fw-medium" style="color: #2d5a46;">
                ...
                <div class="col-lg-6">
                    <div class="ps-lg-3">
                        ...
                        <div class="row g-3 pt-2">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-start gap-3 p-3 rounded-4" style="background-color: var(--sena-pastel-white-green); border-left: 4px solid var(--sena-pastel-primary); border: 1px solid rgba(116, 198, 157, 0.25);">
        ...
        <div class="container py-4">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6 order-2 order-lg-1">
                    <div class="pe-lg-3">
                        ...
                        <div class="d-flex flex-column gap-3 mb-4">
                            <div class="d-flex align-items-center gap-3 bg-white p-3 rounded-4 shadow-sm border" style="border-color: rgba(116, 198, 157, 0.3) !important;">
                            ...
                            <div class="d-flex align-items-center gap-3 bg-white p-3 rounded-4 shadow-sm border" style="border-color: rgba(116, 198, 157, 0.3) !important;">
                                <div class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold shadow-sm" style="width: 44px; height: 44px; background-color: #52b788; flex-shrink: 0;">
                            ...
                            <div class="d-flex align-items-center gap-3 bg-white p-3 rounded-4 shadow-sm border" style="border-color: rgba(116, 198, 157, 0.3) !important;">
                                <div class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold shadow-sm" style="width: 44px; height: 44px; background-color: #80b996; flex-shrink: 0;">
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="ecp-feature-img-box position-relative">
                        <div class="p-5 text-center d-flex flex-column justify-content-center align-items-center" 
                             style="min-height: 420px; background: linear-gradient(135deg, #c7ecc8 0%, #a7dfb8 50%, #80b996 100%);">
                            <div class="rounded-circle p-4 mb-4 shadow-sm" style="background: rgba(255, 255, 255, 0.85); border: 2px solid #ffffff;">
                                <i class="fas fa-hands-holding-child fa-4x" style="color: #1b4332;"></i>
                            </div>
                            <h3 class="fw-bold mb-2" style="color: #1b4332;">Aprender Haciendo en Paz</h3>
                            <p class="small mb-0 px-3 fw-medium" style="color: #2d5a46;">
                        ...
                        <div class="ecp-feature-badge-floating shadow-lg">
                            <div class="rounded-circle p-2 d-flex align-items-center justify-content-center" style="width: 42px; height: 42px; background-color: var(--sena-pastel-light); color: #1b4332;">
                                <i class="fas fa-star fs-5" style="color: #2d6a4f;"></i>
                            </div>
                            <div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ecp-card-feature text-center d-flex flex-column h-100">
                        ...
                        <span class="badge rounded-pill px-3 py-1 mb-2 fw-bold align-self-center" style="font-size: 0.75rem; background-color: var(--sena-pastel-light); color: #1b4332; border: 1px solid rgba(116, 198, 157, 0.4);">
                            MOMENTO 01
                        </span>
                        ...
                        <div class="border-top pt-3 text-start" style="border-color: rgba(116, 198, 157, 0.25) !important;">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ecp-card-feature text-center d-flex flex-column h-100" style="border-top: 4px solid var(--sena-pastel-primary);">
                        <div class="ecp-moment-icon mx-auto" style="background-color: #c7ecc8; color: #1b4332;">
                            <i class="fas fa-hand-holding-heart"></i>
                        </div>

                        <span class="badge rounded-pill px-3 py-1 mb-2 fw-bold align-self-center" style="font-size: 0.75rem; background-color: #b7e4c7; color: #1b4332; border: 1px solid rgba(116, 198, 157, 0.4);">
                            MOMENTO 02
                        </span>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="ecp-card-feature text-center d-flex flex-column h-100">
                        <div class="ecp-moment-icon mx-auto" style="background-color: #d8f3dc; color: #1b4332;">
                            <i class="fas fa-scale-balanced"></i>
                        </div>
    ...
    <!-- ========================================================================= -->
    <!-- 6. FOOTER (Verde Pastel Suave y Claro) -->
    <!-- ========================================================================= -->
    <footer id="contacto" class="ecp-footer">
            ...
            <div class="row g-4 justify-content-between">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <img src="{{ asset('general/assets/img/logo-ecp.png') }}" alt="Logo Escuela Cultura de Paz" style="width: 50px; height: 50px; object-fit: contain; background: white; border-radius: 50%; padding: 2px; border: 2px solid var(--sena-pastel-primary); box-shadow: 0 2px 8px rgba(116, 198, 157, 0.35);">
                        <div>
                            <h4 class="fw-bold mb-0 fs-5" style="color: var(--sena-pastel-text-title);">Control ECP</h4>
                            <span class="fs-7 fw-semibold" style="color: #2d6a4f;">Escuela Cultura de Paz</span>
                        </div>
                    </div>

                    <h5 class="mt-4">Integrantes del Equipo</h5>
                    <p class="small mb-3" style="color: var(--sena-pastel-text-body);">
                        Desarrollado y coordinado por aprendices e instructores del Centro de Formación Agroindustrial La Angostura:
                    </p>
                    <ul>
                        <li><i class="fas fa-user-check"></i> <span><strong>Equipo Pedagógico:</strong> Cultura de Paz ECP</span></li>
                        <li><i class="fas fa-laptop-code"></i> <span><strong>Desarrollo de Software:</strong> Aprendices ADSO / SENA Empresa</span></li>
                        <li><i class="fas fa-chalkboard-user"></i> <span><strong>Instructores Lideres:</strong> Formación y Bienestar</span></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-3">
                        <i class="fas fa-landmark me-2" style="color: var(--sena-pastel-primary);"></i> <strong>Centro de Formación Agroindustrial "La Angostura"</strong><br>
                        <i class="fas fa-map-location-dot me-2 mt-2" style="color: var(--sena-pastel-primary);"></i> Kilómetro 38 Vía al Sur del Huila, Neiva - Campoalegre<br>
                        <i class="fas fa-globe me-2 mt-2" style="color: var(--sena-pastel-primary);"></i> Regional Huila • Colombia
                    </p>
                    <p class="small" style="color: var(--sena-pastel-text-body);">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul>
                        <li><i class="fas fa-phone"></i> <span><strong>Atención SENA:</strong> 01 8000 910270</span></li>
                        <li><i class="fas fa-mobile-screen"></i> <span><strong>Centro La Angostura:</strong> (608) 870 0000</span></li>
                        <li><i class="fas fa-envelope"></i> <span><strong>Correo:</strong> ecp.angostura@sena.edu.co</span></li>
                    </ul>

                    <div class="mt-4">
                        <span class="d-block small mb-2 fw-semibold" style="color: var(--sena-pastel-text-title);">Redes Institucionales:</span>
        ...
        <div class="ecp-footer-bottom">
            <div class="container d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div style="color: var(--sena-pastel-text-body);">
                    &copy; {{ date('Y') }} <strong>Escuela Cultura de Paz (Control ECP)</strong> • SENA La Angostura. Todos los derechos reservados.
                </div>
                <div>
