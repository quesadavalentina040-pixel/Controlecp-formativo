...
<div class="container-fluid px-2 px-md-3 py-2">
    ...
    <div class="mb-4 pb-2 border-bottom">
        ...
        <h2 class="h3 fw-bold mb-0" style="color: #001A29; font-family: 'Outfit', sans-serif;">
            <i class="fas fa-pen-to-square me-2" style="color: #39A900;"></i>Editar Material
        </h2>
        <p class="text-muted small mb-0">Actualiza la información del material seleccionado</p>
    </div>
        ...
        <div class="col-lg-9">
            <div class="card shadow-sm border-0" style="border-radius: 16px;">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('controlecp.administrador.inventario.update', $material->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4 text-center">
                            ...
                            <label for="imagenInput" class="img-drop">
                                <img id="imgPreview"
                                     class="img-preview {{ $material->imagen_url ? '' : 'd-none' }}"
                                     src="{{ $material->imagen_url ?? '' }}"
                                     alt="Vista previa">
                                <div class="img-placeholder {{ $material->imagen_url ? 'd-none' : '' }}" id="imgPlaceholder">
                            ...
                            <div class="small text-muted mt-2">
                                Clic en el recuadro para cambiar la imagen. Si no seleccionas nada se conserva la actual.
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ubicacion" value="{{ old('ubicacion', $material->ubicacion) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="cantidad" value="{{ old('cantidad', $material->cantidad) }}" min="0"
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="unidad" class="form-select @error('unidad') is-invalid @enderror">
                                    @foreach($unidades as $u)
                                        <option value="{{ $u }}" {{ old('unidad', $material->unidad) == $u ? 'selected' : '' }}>{{ $u }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="stock_minimo" value="{{ old('stock_minimo', $material->stock_minimo) }}" min="0"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="estado" class="form-select @error('estado') is-invalid @enderror">
                                    @foreach($estados as $e)
                                        <option value="{{ $e }}" {{ old('estado', $material->estado) == $e ? 'selected' : '' }}>{{ $e }}</option>
                                    @endforeach
                                </select>
